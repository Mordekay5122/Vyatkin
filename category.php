...
$query3 = "SELECT id_product, name_product, FK_category, manufacturer, country, price, picture FROM products WHERE FK_category =".$type;
			...
			<div class="box categories">
				...
				<div class="box-content">
					<ul>
						...
						{ ?>
					    <li><a href="category.php?type=<?php print $row2["id_category"];?>"><?php print $row2["category"];?></a></li>
					    <?php }?>
					</ul>
				</div>
			</div>
